...
function getLongestDinosaur(dinosaurs) {
  ...
  //   const dinosaurName = dinosaurs.name;
  //   if (dinosaurs.lengthInMeters > longestDinosaur) {
  //     longestDinosaurLengthInFeet = dinosaurs.lengthInMeters;
  //     if (!result[dinosaurName]) {
  //       result[dinosaurName] = [];
  //     }
  //   }
