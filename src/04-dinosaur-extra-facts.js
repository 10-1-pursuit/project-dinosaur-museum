...
function threeLongestDinosaurs(dinosaursArrayList){
    let first = .0003
    let firstId = ""
    let second = .0002
    let secondId = ""
...
function threeOldestDinosaurs(dinosaursArrayList){
    return;
}

function allSamePeriodDinosaurs(dinosaursArrayList, period){
    return;
}

function allSameDietDinosaurs(dinosaursArrayList, diet){
    return;
}

function allFactsTogether(dinosaursArrayList){
...
console.log(threeLongestDinosaurs(dinosaurs))