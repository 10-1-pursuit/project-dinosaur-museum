...
describe("getDinosaurDescription()", () => {
  test("should return a string description of a dinosaur, by ID", () => {
    ...
    const expected =
      "Xenoceratops (ZEE-no-SEH-ruh-tops)\nXenoceratops had horns and a bony frill with elaborate ornamentation of projections, knobs, and spikes. It lived in the Early Cretaceous period, over 78.5-77.5 million years ago.";
    expect(actual).toEqual(expected);
  });
